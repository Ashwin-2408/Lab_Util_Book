...
export default function Audit() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setAllScheduleReq(response.data);
      })
      .catch((error) =>
        console.log(
  ...
  return (
    <div style={{ margin: "1rem", fontFamily: "Roboto" }}>
      ...
      >
        ...
        >
          Track all approval and rejection decisions for complete accountability
        </div>
      </div>
      <div
        style={{
          ...
          >
            <div
              style={{
                ...
                height: "2rem",
                borderTop: "1px solid rgb(138, 138, 138)",
              }}
            ...
            >
              ...
              >
                {elem.status === "approved" ? (
                  <CircleCheck size={16} style={{ color: "lightgreen" }} />
              ...
              >
                ...
                <div style={{ color: "rgb(139, 139, 139)", width: "5rem" }}>
            ...
            {(showDetails != null) & (showDetails === elem.id) ? (
              ...
              >
                <div>
                  <div
                    style={{ fontSize: "0.8rem", color: "rgb(127, 127, 127)" }}
                  >
                    Auditor
                  </div>
